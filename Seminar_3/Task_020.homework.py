...
dictionary_eng = {'A': 1, 'E': 1, 'I': 1, 'O': 1, 'U': 1, 'L': 1, 'N': 1, 'S': 1, 'T': 1, 'R': 1,
                  'D': 2, 'G': 2, 'B': 3, 'C': 3, 'M': 3, 'P': 3, 'F': 4, 'H': 4, 'V': 4, 'W': 4,
                  'Y': 4, 'K': 5, 'J': 8, 'X': 8, 'Q': 10, 'Z': 10}

dictionary_rus = {'А': 1, 'В': 1, 'Е': 1, 'И': 1, 'Н': 1, 'О': 1, 'Р': 1, 'С': 1, 'Т': 1, 'Д': 2,
...
res=0
for i in slovo:
    if i in dictionary_eng:
        res+=dictionary_eng[i]
    elif i in dictionary_rus:
        res+=dictionary_rus[i]
print(res)
...
#               8: "J, X, Ш, Э, Ю ",
#               10: "Q, Z, Ф, Щ, Ъ "}
# word = input("Введите нужное слово : ")
# count = 0
# for i in word:
